...
(
    ...
    duration_of_action                                   int unsigned                             null comment 'Estimated duration of time following the onset delay in which a stimulus produces a perceivable outcome',
    variable_category_id                                 tinyint unsigned                         null comment 'ID of variable category',
    predictor_only                                           tinyint(1)                               null comment 'A value of 1 indicates that this variable is generally a predictor in a causal relationship.  An example of a predictorOnly variable would be a variable such as Cloud Cover which would generally not be influenced by the behaviour of the user',
