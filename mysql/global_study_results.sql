...
(
    ...
    is_boring                                                       tinyint(1)                                                      null comment 'The relationship is is_boring if it is obvious, the predictor is not controllable, or the outcome is not a goal, the relationship could not be causal, or the confidence is low.  ',
