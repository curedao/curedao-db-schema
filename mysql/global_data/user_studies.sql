...
(
    ...
    relationship_id                int unsigned                          null comment 'ID of the relationship statistics',
    ...
    constraint user_studies_slug_uindex
        unique (slug),
    constraint user_studies_predictor_gv_id_variables_id_fk
        foreign key (predictor_global_variable_id) references global_variables (id),
    constraint user_studies_oauth_client_id_fk
        foreign key (oauth_client_id) references oauth_clients (id),
    constraint user_studies_outcome_gv_id_variables_id_fk
...
create index predictor_global_variable_id
    on user_studies (predictor_global_variable_id);

create index outcome_global_variable_id
    on user_studies (outcome_global_variable_id);
