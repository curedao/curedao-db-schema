...
(
    ...
    duration_of_action                                  int unsigned                                    null comment 'How long the outcome of a measurement in this variable lasts',
    ...
    average_seconds_between_measurements                int                                             null comment '[Calculated] Average seconds between measurements for the average user.  Helps identify duplicate or erroneous data and spamming of the database.',
    ...
    abbreviated_name                                    varchar(100)                                    null comment
        '[Admin-Setting] Canonical shorter version of the name or scientific abbreviation',
