...
mean value as a function of the number of data points.',
    ...
    conversion_factor                double                              not null comment 'Number by which we multiply the food or composite user variable value to obtain the ingredient user variable value',
...
create index user_variable_food_ingredient_tag_variable_unit_id_fk
    on user_variable_food_ingredient (ingredient_user_variable_unit_id);

create index user_variable_food_ingredient_tagged_variable_unit_id_fk
    on user_variable_food_ingredient (food_user_variable_unit_id);
