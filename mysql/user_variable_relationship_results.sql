...
(
    ...
    is_plausibly_causal                                             tinyint(1)                                                      null comment 'The outcome of aspirin on headaches is plausibly causal. The outcome of aspirin on precipitation does not have a plausible causal relationship. ',
    is_obvious                                                      tinyint(1)                                                      null comment 'The outcome of aspirin on headaches is obvious. The outcome of aspirin on productivity is not obvious. ',
    ...
    relationship_direction                                                 enum ('POSITIVE', 'NEGATIVE', 'NONE')                           not null comment 'If higher predictor values generally precede HIGHER outcome values, the relationship is considered POSITIVE.  If higher predictor values generally precede LOWER outcome values, the relationship is considered NEGATIVE. ',
